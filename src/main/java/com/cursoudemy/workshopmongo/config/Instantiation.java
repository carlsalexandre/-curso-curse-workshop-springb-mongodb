...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2024"), "Indo viajar", "E levar meus cachorros junto.", alex);
        Post post2 = new Post(null, sdf.parse("24/03/2024"), "Voltando da viagem", "Os cachorros aprontaram muito.", alex);
